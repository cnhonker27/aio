...
public enum AioHttpContentTypeEnums {
    All(".*","application/octet-stream"),
    ONE("0.001","application/x-001"),
    THREE("0.323","text/h323"),
    NIGHHT("0.907","drawing/907"),
    ...
    T301("0.301","application/x-301"),
    T906("0.906","application/x-906"),
    ...
    APPT(".ppt","application/vnd.ms-powerpoint"),
    PR(".pr","application/x-pr"),
    PRN(".prn","application/x-prn"),
    APS(".ps","application/x-ps"),
    ...
    VML(".vml","text/xml"),
    AVSD(".vsd","application/vnd.visio"),
    VSS(".vss","application/vnd.visio"),
    AVST(".vst","application/x-vst"),
    ...
    AXLS(".xls","application/vnd.ms-excel"),
    ...
    AioHttpContentTypeEnums(String key, String value) {
        this.key=key;
        this.value=value;
    }
    ...
    public static AioHttpContentTypeEnums formatterKey(String key){
        for (AioHttpContentTypeEnums value : values()) {
            if(value.getKey().equals(key)){
                return value;
            }
        }
        throw new IllegalArgumentException("该"+key+"不存在");
    }
